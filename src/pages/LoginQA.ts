...
export default class UserPage {
    ...
    private Elements = {
        QAlogin: "//button[contains(@class,'text-l rounded-md')]",
        ...
        usernamevalidation: "//span[normalize-space(text())='Username is required.']",
        passwordvalidation:"//span[normalize-space(text())='Password is required.']",
        ...
        InvalidCredentials: "//p[normalize-space(text())='Invalid Credentials']"
    ...
    async ClickLoginQA() {
        ...
        await this.page.click(this.Elements.QAlogin);
    }
    ...
    async Mandatoryfields() {
        const usenamevalidation = await this.page.innerText(this.Elements.usernamevalidation);
        console.log(usenamevalidation);
        const passwordvalidation = await this.page.innerText(this.Elements.passwordvalidation);
    ...
    async InvalidCredentials() {
        const InvalidCredentials = await this.page.innerText(this.Elements.InvalidCredentials);
